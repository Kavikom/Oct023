   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            <oracle-xsl-mapper:schema location="../../WSDLs/BiilingSystemBPELProcess.wsdl"/>
            <oracle-xsl-mapper:rootElement name="bsRequest" namespace="http://xmlns.oracle.com/SOAPractice/BillingManagementSystem/BiilingSystemBPELProcess"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="WSDL">
            <oracle-xsl-mapper:schema location="../../WSDLs/BiilingSystemBPELProcess.wsdl"/>
            <oracle-xsl-mapper:rootElement name="bsResponse" namespace="http://xmlns.oracle.com/SOAPractice/BillingManagementSystem/BiilingSystemBPELProcess"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [THU NOV 09 19:50:51 IST 2023].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:bsResponse>
         <ns0:ordID>
            <xsl:value-of select="/ns0:bsRequest/ns0:ordID"/>
         </ns0:ordID>
